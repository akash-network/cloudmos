...
export const SdlBuilder = React.forwardRef<SdlBuilderRefType, Props>(({ sdlString, setEditedManifest }, ref) => {
  ...
  const createAndValidateSdl = (yamlStr: string) => {
    try {
      ...
      const services = importSimpleSdl(yamlStr, providerAttributesSchema as ProviderAttributesSchema);
        ...
        <form ref={formRef} autoComplete="off">
          {services.map((service, serviceIndex) => (
            <SimpleServiceFormControl
              ...
              providerAttributesSchema={providerAttributesSchema as ProviderAttributesSchema}
              control={control}
              trigger={trigger}
